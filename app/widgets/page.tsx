  ...
  const widgets = [
    {
      ...
      description:
        "Generates a workout plan given a set of exercises and other paramaters and then posts it to a notion database",
      icon: <GiMuscleUp />,
    },
    { title: "Widget 2", description: "TBA but it'll be good" },
    { title: "Widget 3", description: "TBA but it'll be good" },
    { title: "Widget 4", description: "TBA but itl'l be good" },
  ];
  ...
  return (
    <Layout>
      <Section>
        ...
        <SectionText>
          A collection of tools that I was too curious not to make
        </SectionText>
        <GridContainer>
          {widgets.map((widget) => {
            return (
